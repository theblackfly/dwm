...
static char *fonts[]          = { "UbuntuMonoNerdFont:size=14", "JoyPixels:pixelsize=17:antialias=true:autohint=true"  };
...
static char normbgcolor[]           = "#292b2e";
static char normbordercolor[]       = "#444444";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#eeeeee";
static char selbordercolor[]        = "#f8f8f8";
static char selbgcolor[]            = "#444155";  // or "#5d4d7a"
...
static Key keys[] = {
	...
	{ MODKEY,			XK_s,		setlayout,	{.v = &layouts[8]} }, /* grid */
  ...
  /* In LARBS, `super + n` is now mapped in sxhkdrc instead. */
	/* { MODKEY,			XK_n,		spawn,		SHCMD(TERMINAL " -e nvim -c VimwikiIndex") }, */
	{ MODKEY|ShiftMask,		XK_n,		spawn,		SHCMD(TERMINAL " -e newsboat; pkill -RTMIN+6 dwmblocks") },
  /* In LARBS, `super + m` is now mapped in sxhkdrc instead. */
  ...
  /* The arrow is just way to far. Might as well use the mouse then. */
	...
	{ 0,				XK_Print,	spawn,		SHCMD("maim ~/pictures/screenshots/$(date '+%y%m%d-%H%M-%S').png") },
	{ ShiftMask,			XK_Print,	spawn,		SHCMD("maimpick ~/pictures/screenshots/$(date '+%y%m%d-%H%M-%S').png") },
